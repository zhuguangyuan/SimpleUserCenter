...
public final class UserPreferencesServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<UserPreferencesRequest,
          UserPreferencesResponse> getGetShortlistedMoviesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getShortlistedMovies",
      requestType = UserPreferencesRequest.class,
      responseType = UserPreferencesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<UserPreferencesRequest,
          UserPreferencesResponse> getGetShortlistedMoviesMethod() {
    io.grpc.MethodDescriptor<UserPreferencesRequest, UserPreferencesResponse> getGetShortlistedMoviesMethod;
      ...
      synchronized (UserPreferencesServiceGrpc.class) {
        if ((getGetShortlistedMoviesMethod = UserPreferencesServiceGrpc.getGetShortlistedMoviesMethod) == null) {
          UserPreferencesServiceGrpc.getGetShortlistedMoviesMethod = getGetShortlistedMoviesMethod =
              io.grpc.MethodDescriptor.<UserPreferencesRequest, UserPreferencesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getShortlistedMovies"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  UserPreferencesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  UserPreferencesResponse.getDefaultInstance()))
  ...
  public static abstract class UserPreferencesServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<UserPreferencesRequest> getShortlistedMovies(
        io.grpc.stub.StreamObserver<UserPreferencesResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getGetShortlistedMoviesMethod(), responseObserver);
    }
  ...
  private static abstract class UserPreferencesServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return Userpreferences.getDescriptor();
    }
