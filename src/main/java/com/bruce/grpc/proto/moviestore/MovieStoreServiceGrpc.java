...
public final class MovieStoreServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<MovieStoreRequest,
          MovieStoreResponse> getGetMoviesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getMovies",
      requestType = MovieStoreRequest.class,
      responseType = MovieStoreResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<MovieStoreRequest,
          MovieStoreResponse> getGetMoviesMethod() {
    io.grpc.MethodDescriptor<MovieStoreRequest, MovieStoreResponse> getGetMoviesMethod;
      ...
      synchronized (MovieStoreServiceGrpc.class) {
        if ((getGetMoviesMethod = MovieStoreServiceGrpc.getGetMoviesMethod) == null) {
          MovieStoreServiceGrpc.getGetMoviesMethod = getGetMoviesMethod =
              io.grpc.MethodDescriptor.<MovieStoreRequest, MovieStoreResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getMovies"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  MovieStoreRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  MovieStoreResponse.getDefaultInstance()))
  ...
  public static abstract class MovieStoreServiceImplBase implements io.grpc.BindableService {
    ...
    public void getMovies(MovieStoreRequest request,
                          io.grpc.stub.StreamObserver<MovieStoreResponse> responseObserver) {
  ...
  public static final class MovieStoreServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MovieStoreServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<MovieStoreResponse> getMovies(
        MovieStoreRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MOVIES:
          serviceImpl.getMovies((MovieStoreRequest) request,
              (io.grpc.stub.StreamObserver<MovieStoreResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MovieStoreServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return Moviestore.getDescriptor();
    }
